...
/*** cardio-murmur2 ***/
	"002":
	{
		...
		images : [
			{ type: "image", src: "cardio/left_image/case10.jpg"},
			{ type: "image", src: "cardio/Heart-1.jpg"},
		],

		text: 
"【症例⑩】心房中隔欠損（Atrial septal defect:ASD）（肺高血圧あり）\n\
\n\
		...
		menu: [
			{ text: "📢⑩心房中隔欠損を聴く", action:"bodymap", param:{
																...
																sound: {
																	...
																	cardiacsoundT: { src:"case10(T).mp3", r1:10, v1:0.5, r2:40, v2:0.1 },
...
CASE_LIST["murmur-B10"] = {
	type: TYPE_CASE,
	title: "症例⑩　心房中隔欠損（肺高血圧あり）",
