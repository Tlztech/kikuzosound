...
$(document).ready(function () {
    ...
    function loadBodyFunction(sound, isOpen, is_exam_quiz) {
        ...
        if (isOpen) {
            ...
            if (heartFActive) {
                url = SITEURL + "/ausculaide_app?id="+sound.id+"&case=normal-A1"
                $('.audio_slider').slider('enable');
                case_type = "heart";
            }

            if (heartFAndPulseActive) {
                url = SITEURL + "/ausculaide_app?id="+sound.id+"&case=normal-A2"
                $('.audio_slider').slider('enable');
                case_type = "heart_pulse";
            }

            if (heartFAndLungsActive) {
                url = SITEURL + "/ausculaide_app?id="+sound.id+"&case=normal-A3"
                $('.audio_slider').slider('disable');
                case_type = "heart_lungs";
            }

            if (heartFPulseLungsActive) {
                url = SITEURL + "/ausculaide_app?id="+sound.id+"&case=normal-A4_2"
                $('.audio_slider').slider('disable');
            ...
            if (lungsFActive) {
                url = SITEURL + "/ausculaide_app?id="+sound.id+"&case=normal-A5"
                $('.audio_slider').slider('disable');
                case_type = "lungs";
            ...
            if (lungsBActive) {
                url = SITEURL + "/ausculaide_app?id="+sound.id+"&case=normal-A6"
                $('.audio_slider').slider('disable');
