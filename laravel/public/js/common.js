...
$(document).ready(function () {
    ...
    function handleClickSwitchBody(e, sound, exam_quiz) {
        ...
        let isOpen = exam_quiz ? true : $("#aus_" + sound.id).hasClass("open_active") || $("#aus_" + sound.id).hasClass("recommended_data");
        if (isOpen) {
            if (!isFront) {
                ...
                var lungIcon = $("#lung_icon_" + sound.id).attr("data-lung-back");
                if (exam_quiz) {
                    lungIcon = $("#exam_lung_icon_" + sound.id).attr("data-lung-back");
                }
                if (lungIcon == 1) {
                    $("#lung_icon_" + sound.id).removeClass("btn-lung-grey-icon");
                    $("#lung_icon_" + sound.id).addClass("btn-lung-icon");
                    ...
                    localStorage.setItem("lung", 0);
                    $("#lung_icon_" + sound.id).removeClass("btn-lung-icon");
                    $("#lung_icon_" + sound.id).addClass("btn-lung-grey-icon");
                    $("#lung_icon_" + sound.id).prop("disabled", true);
                }
                ...
                if (exam_quiz) {//set default in exam quiz
                    ...
                    var lungIcon = $("#lung_icon_" + sound.id).attr("data-lung-front");
                    if (lungIcon == 1) {
                        $("#lung_icon_" + sound.id).removeClass("btn-lung-grey-icon");
                        $("#lung_icon_" + sound.id).addClass("btn-lung-icon");
                        localStorage.setItem("lung", 1);
