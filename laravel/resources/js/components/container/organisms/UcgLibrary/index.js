...
// components
import EditModal from "../UcgLibraryEdit/index";
      ...
      <>
        ...
        {isEditModalVisible && (
          <EditModal
            ...
            updateUcgData={(data, id) => this.props.updateUcgData(data, id)}
...
const onDragEnd = (result, table_data, context) => {
  ...
  context.props.updateUcgOrder(items, context.props.userInfo.id);
};
...
const getTableData = (context, table_data) => {
  ...
  return (
    ...
    >
      <Droppable droppableId={"ucg-drag"}>
        {(provided) => (
...
// Export
//===================================================
export default withTranslation("translation")(UcgLIbrary);
