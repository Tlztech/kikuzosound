...
<form class="form-horizontal" action="{{ route('admin.ecg_library.update', $stetho_sound->id) }}" method="POST"
    ...
    <div class="well">
        ...
        <div class="form-group @if($errors->has('lib_image_file')) has-error @endif">
            <label for="ecg-file-field" class="col-sm-2 control-label">画像ファイル</label>
            <div class="col-sm-10">
                <input type="hidden" name="lib_type" value="5" />
                ...
                <?php
                  ...
                  if ( count($errors) ) {
                    $lib_image_file_path = $stetho_sound->image_path;
                  }
                  else {
                ...
                ?>
                <img id="lib_image_file_image-img"
                    src="@if(!is_null($lib_image_file_path)){{ $lib_image_file_path.'?v='.session('version') }}@endif"
        ...
        <div class="form-group @if($errors->has('description')) has-error @endif">
            <label for="description-field" class="col-sm-2 control-label">レントゲン説明 (JP)</label>
            <div class="col-sm-10">
        ...
        <div class="form-group @if($errors->has('description_en')) has-error @endif">
            <label for="description-field" class="col-sm-2 control-label">レントゲン説明 (EN)</label>
            <div class="col-sm-10">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <a class="btn btn-default" href="{{ route('admin.xray_library.index') }}?page={{ $page }}">キャンセル</a>
