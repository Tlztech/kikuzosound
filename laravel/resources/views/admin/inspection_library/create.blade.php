...
<form class="form-horizontal" action="{{ route('admin.inspection_library.store') }}" method="POST"
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <a class="btn btn-default" href="{{ route('admin.inspection_library.index') }}">キャンセル</a>
