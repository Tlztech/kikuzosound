...
<form class="form-horizontal" action="{{ route('admin.palpation_library.update', $stetho_sound->id) }}" method="POST"
    ...
    <div class="well">
        ...
        <div class="form-group">
            <input type="hidden" name="lib_type" value="4" />
        ...
        <div class="form-group @if($errors->has('lib_video_file')) has-error @endif">
            ...
            <div class="col-sm-10">
                ...
                @if (file_exists(public_path($video_path)))
                    <video id="lib_video_file-video" controls src="@if($video_path){{ url('/').$video_path.'?v='.session('version') }} @endif" style="@if(empty($video_path)) display:none; @endif"></video>
        ...
        <div class="form-group @if($errors->has('description')) has-error @endif">
            <label for="description-field" class="col-sm-2 control-label">視診説明 (JP)</label>
            <div class="col-sm-10">
        ...
        <div class="form-group @if($errors->has('description_en')) has-error @endif">
            <label for="description-field" class="col-sm-2 control-label">視診説明 (EN)</label>
            <div class="col-sm-10">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <a class="btn btn-default" href="{{ route('admin.inspection_library.index') }}?page={{ $page }}">キャンセル</a>
