            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select class="form-control" name="quiz_pack">
                        ...
                        <option value="{{$quiz_pack->id}}" data-description="{{$quiz_pack->title}}" @if(old('quiz_pack')==$quiz_pack->id) selected @endif>
            ...
            <div class="form-group @if($errors->has('enabled')) has-error @endif">
                ...
                <div class="col-sm-10">
                    <label class="radio-inline">
                        <input type="radio" name="enabled" id="enabled" value="1" checked> 公開
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="enabled" id="disabled" value="0"> 非公開
                    </label>
