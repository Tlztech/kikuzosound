...
<div class="row">
    <div class="col-sm-12">
        ...
        <form class="form-horizontal" action="{{ route('admin.quizzes.store') }}" method="POST"
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="file" class="well well-sm" id="quiz_image-field"
                                                            ...
                                                            value="" />
                                                        <img src="@if(!is_null($quiz_image_path)){{ $quiz_image_path }}@endif"
                                                            style="@if(!is_null($quiz_image_path))height:220px;@endif @if(is_null($quiz_image_path))display:none;@endif" />
                                                        <input type="hidden" name="image_path"
                                                            value="@if(!is_null($quiz_image_path)){{ $quiz_image_path }}@endif" />
                                                        @if($errors->has("image"))
                                                        <span class="help-block">{{ $errors->first("image") }}</span>
                                                        @endif
                                                        @if($errors->has("quiz_image_path"))
                                                        <span
                                                            class="help-block">{{ $errors->first("quiz_image_path") }}</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <div
                                            ...
                                            <div class="col-sm-5">
                                                <input type="number" id="case_age-field" name="case_age"
                                                    class="form-control" value="{{ old('case_age') }}" placeholder="歳"
                                                    min="1" />
                                    ...
                                    <div class="form-group @if($errors->has('case')) has-error @endif">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="description-field" name="case"
                                                class="form-control">{{ old("case") }}</textarea>
                                            @if($errors->has("case"))
                                    ...
                                    <div class="form-group @if($errors->has('case_en')) has-error @endif">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="description-en-field" name="case_en"
                                                class="form-control">{{ old("case_en") }}</textarea>
                                    ...
                                    <div class="form-group @if($errors->has('limit_seconds')) has-error @endif">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" id="limit_seconds-field" name="limit_seconds"
                                                min="0"
                                                class="form-control" value="{{ old('limit_seconds') }}"
                                                placeholder="30" />
                                            ...
                                            <div class="radio">
                                                <label class="col-sm-2">
                                                    <input type="radio"  name="is_optional" value='1'
                                                        {{ old("is_optional",1)==1 ? "checked" : "" }} />選択式
                                                </label>
                                                <label class="col-sm-2">
                                                    <input type="radio"  name="is_optional" value='0'
                                                        {{ !is_null(old("is_optional")) && old("is_optional")==0 ? "checked" : "" }} />文章式
                                                </label>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="col-md-10"><input type="text"
                                                                        ...
                                                                        class="form-control"
                                                                        value="{{old($lib['input_name'].'_quiz_choices.fill_in.title')}}">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="{{$lib['input_name']}}_description"
                                                        ...
                                                        <option
                                                            ...
                                                            @if(old($lib['input_name']."_description")==$stetho_sound->
                                                            id)
                                                            selected @endif>
