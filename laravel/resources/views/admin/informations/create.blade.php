...
<div class="row">
    <div class="col-md-10">
        ...
        <form class="form-horizontal" action="{{ route('admin.informations.store') }}" method="POST" enctype="multipart/form-data">
            ...
            {{-- <div class="form-group @if($errors->has('title_en')) has-error @endif">
                ...
                <div class="col-sm-10">
                    <input type="text" id="title-field" name="title_en" class="form-control" value="{{ old('title') }}" placeholder="日付 (EN)"/>
            ...
            <div class="form-group @if($errors->has('description')) has-error @endif">
                ...
                <div class="col-sm-10">
                    <textarea type="text" id="description_en-field" name="description" class="form-control" placeholder="お知らせ (JP)" >{{ old('description') }}</textarea>
            ...
            <div class="form-group @if($errors->has('description_en')) has-error @endif">
                ...
                <div class="col-sm-10">
                    <textarea type="text" id="description_en-field" name="description_en" class="form-control" placeholder="お知らせ (EN)" >{{ old('description_en') }}</textarea>
