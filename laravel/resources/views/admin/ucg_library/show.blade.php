...
<div class="well library-file">
  ...
  -->
  <!-- プレイヤー -->
  <strong>動画ファイル：</strong><br/><br/>
  @if($stetho_sound->video_path)
  <div class="row stetho_sound_images">
    <div style="" class="col-md-3 text-center">
      <video src="{{ $stetho_sound->video_path.'?_='.session('version') }}" controls style="width:300px; height:200px;"></video>
    </div>
  </div>
  @else
  ビデオファイルが指定されていません。
