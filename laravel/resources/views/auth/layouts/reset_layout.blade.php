...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div id="header">
        ...
        <div class="header_inner">
            <!-- .title_h1 -->
            <h1 class="header_explanation sp_none"><img src="../../img/icon.png" alt="">@lang('app.header_explanation')
            </h1>
            <!-- /.title_h1 -->
            <!-- .headlogo -->
            <div class="headlogo">
            ...
            <div class="gnavi_pc">
                ...
                <ul class="menu">
                    ...
                    <!-- <li class="@if( $route_name=='video'             ) active @endif"><a
                            href="{{ route('video')   }}">@lang('app.video')</a></li> -->
                </ul>
                <!-- /.menu -->
            </div>
            <!-- /.gnavi_pc -->
    ...
    <div id="footer">
        ...
        <div class="footer_inner">
            ...
            <div class="sns_link">
                {{-- Twitter --}}
                {{-- Twitterのweb page 表示 --}}
                <a href="https://twitter.com/share?url=https%3A%2F%2Fkikuzosound.com&hashtags=聴診%2C聴診音%2C心音%2C肺音%2C腸音%2Cフィジカルアセスメント」&text=「聴診音が学べる！ポータルサイト"
