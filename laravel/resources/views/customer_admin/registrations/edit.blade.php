            ...
            <ul class="contact_form">
                <li>
                    <label for="" class="">
                        ...
                        <input type="text" name="user" value="{{$exam->user}}" required="required">
                    </label>
                </li>
                <li>
                    <label for="" class="">
                        ...
                        <input type="text" name="password" value="{{old('password')}}" placeholder="半角英数字">
                ...
                <li>
                    <label for="" class="">
                        ...
                        <input type="text" name="speaker" value="{{old('speaker')}}" placeholder="半角英数字">&nbsp&nbsp ※何も入れない場合は、前のままのパスワードになります<br>
                    </label>
                </li>
                <li>
                    <label for="" class="">
