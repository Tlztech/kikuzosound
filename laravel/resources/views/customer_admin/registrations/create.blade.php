            ...
            <ul class="contact_form">
                <li>
                    <label for="" class="">
                        ...
                        <input type="text" name="user" value="{{old('user')}}" placeholder="半角英数字" required="required">
                    </label>
                </li>
                <li>
                    <label for="" class="">
                        ...
                        <input type="text" name="password" value="{{old('password')}}" placeholder="半角英数字" required="required">
                    </label>
                </li>
                <li>
                    <label for="" class="">
                        ...
                        <input type="text" name="speaker" value="{{old('speaker')}}" placeholder="半角英数字" required="required">
                    </label>
                </li>
                <li>
                    <label for="" class="">
                ...
                <li>
                    <label for="" class="">
                        ...
                        <input type="text" name="disp_order" id="disp_order" value="{{old('disp_order')}}" placeholder="idをcsvで表示順に記述(例:2,45,32)" required="required">&nbsp&nbsp
